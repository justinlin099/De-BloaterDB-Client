...
def GenerateSelectionWindow():
    ...
    btnFrame.pack(fill=tk.X, pady=5, padx=5)
    ...
    desktopDataBaseBtn.grid(row=1, column=0, ipady=10, ipadx=20,padx=5, pady=5)

    #選擇模式按鈕UWP程式編輯器
    uwpDataBaseBtn = ttk.Button(btnFrame, image=uwpAppIcon, text="UWP程式資料庫編輯器", compound=tk.TOP, bootstyle="Primary")
    uwpDataBaseBtn.grid(row=1, column=1, ipady=10, ipadx=20,padx=5, pady=5)
